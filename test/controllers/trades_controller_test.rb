...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post trades_url, params: { trade: { entry: @trade.entry, stopLoss: @trade.stopLoss, symbol: @trade.symbol, targetProfit: @trade.targetProfit } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { entry: @trade.entry, stopLoss: @trade.stopLoss, symbol: @trade.symbol, targetProfit: @trade.targetProfit } }
